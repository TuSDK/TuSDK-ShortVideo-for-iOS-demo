...
- (void)initRecorderView;
{
    ...
    _topBar = [[TopNavBar alloc]initWithFrame:CGRectMake(0, topY + 4, self.view.lsqGetSizeWidth, 44)];
    ...
    [_bottomBar.recordButton setCenter:CGPointMake(_bottomBar.frame.size.width/2, _bottomBar.frame.size.height*0.7)];
    [_bottomBar.touchView setCenter:CGPointMake(_bottomBar.frame.size.width/2, _bottomBar.frame.size.height*0.7)];
    [_bottomBar.recordButton setImage:[UIImage imageNamed:@"style_default_btn_record_b_1.11.png"] forState:UIControlStateSelected];
    [_bottomBar.recordButton setImage:[UIImage imageNamed:@"style_default_btn_record_s_1.11.png"] forState:UIControlStateNormal];
    
    [_bottomBar.stickerButton setFrame:CGRectMake(0, 0, buttonWidth, buttonHeight)];
    [_bottomBar.stickerButton setImage:[UIImage imageNamed:@"style_default_btn_sticker_w_1.11"] forState:UIControlStateNormal];
    [_bottomBar.stickerButton setCenter:CGPointMake(_bottomBar.frame.size.width*0.12, _bottomBar.frame.size.height*0.7)];
    
    [_bottomBar.filterButton setFrame:CGRectMake(0, 0, buttonWidth, buttonHeight)];
    [_bottomBar.filterButton setCenter:CGPointMake(_bottomBar.frame.size.width*0.28, _bottomBar.frame.size.height*0.7)];
    [_bottomBar.filterButton setImage:[UIImage imageNamed:@"style_default_1.7.1_btn_filter_w_1.11"] forState:UIControlStateNormal];
    
    [_bottomBar.cancelButton setFrame:CGRectMake(0, 0, buttonWidth, buttonHeight)];
    [_bottomBar.cancelButton setCenter:CGPointMake(_bottomBar.frame.size.width*0.72, _bottomBar.frame.size.height*0.7)];
    [_bottomBar.cancelButton setImage:[UIImage imageNamed:@"style_default_btn_back_w_1.11"] forState:UIControlStateNormal];
    
    [_bottomBar.completeButton setFrame:CGRectMake(0, 0, buttonWidth, buttonHeight)];
    [_bottomBar.completeButton setCenter:CGPointMake(_bottomBar.frame.size.width*0.88, _bottomBar.frame.size.height*0.7)];
    [_bottomBar.completeButton setImage:[UIImage imageNamed:@"style_default_btn_finish_w_1.11"] forState:UIControlStateNormal];
    
    [_bottomBar.stickerLabel setCenter:CGPointMake(_bottomBar.stickerButton.center.x, _bottomBar.stickerButton.center.y + buttonHeight/2 + labelHeight/2)];
    _bottomBar.stickerLabel.hidden = YES;
//    text = @"贴纸";
//    _bottomBar.stickerLabel.textColor = [UIColor whiteColor];
    
    [_bottomBar.filterLabel setCenter:CGPointMake(_bottomBar.filterButton.center.x, _bottomBar.stickerButton.center.y + buttonHeight/2 + labelHeight/2)];
    _bottomBar.filterLabel.hidden = YES;
//    text = @"滤镜";
//    _bottomBar.filterLabel.textColor = [UIColor whiteColor];
    
    [_bottomBar.cancelLabel setCenter:CGPointMake(_bottomBar.cancelButton.center.x, _bottomBar.stickerButton.center.y + buttonHeight/2 + labelHeight/2)];
    _bottomBar.cancelLabel.hidden = YES;
//    text = @"回删";
//    _bottomBar.cancelLabel.textColor = [UIColor whiteColor];
    
    [_bottomBar.completeLabel setCenter:CGPointMake(_bottomBar.completeButton.center.x, _bottomBar.stickerButton.center.y + buttonHeight/2 + labelHeight/2)];
    _bottomBar.completeLabel.hidden = YES;
//    text = @"完成";
//    _bottomBar.completeLabel.textColor = [UIColor whiteColor];
}
...
- (void)initProgressView;
{
    ...
    // 添加时间进度条
    _underView = [[UIView alloc]initWithFrame:CGRectMake(0, topY, self.view.lsqGetSizeWidth, 4)];
    [_underView setBackgroundColor:[UIColor colorWithRed:0.87 green:0.82 blue:0.76 alpha:0.2]];
    ...
    _minSecondView.backgroundColor = [UIColor clearColor];
...
- (void)createFilterView;
{
    if (!_filterBottomView) {
        ...
        _filterBottomView.backgroundColor = [UIColor colorWithWhite:1 alpha:0.5];
...
- (void)createStikerView;
{
    if (!_stickerView) {
        ...
        _stickerView.backgroundColor = [UIColor colorWithWhite:1 alpha:0.5];
